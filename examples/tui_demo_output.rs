...
fn main() {
    ...
    println!(
        "│ {} │",
        "🔬 Interactive Membrane Laboratory 🎯 Press G to generate more!"
            .color(Color::LightYellow)
            .bold()
    );
    println!("└─{}─┘", "─".repeat(76));
    println!(
        "┌─ Configuration ─┬─ Construction ─┬─ Results ─┬─ {} ─┬─ Statistics ─┐",
        "Heat Map".color(Color::Yellow)
    );
    println!("└─────────────────┴────────────────┴───────────┴──────────┴──────────────┘");
    ...
    println!(
        "\n  {} gcd(1,6)=1, gcd(5,6)=1",
        "✓ Valid configuration".color(Color::Green).bold()
    );
    ...
    println!(
        "│ {} │",
        "🔬 Interactive Membrane Laboratory ✨ PRIME FOUND!"
            .color(Color::Green)
            .bold()
    );
    println!("\n{}", "Live Construction:".color(Color::Green));
    println!(
        "\n  Building membrane number with seed {}",
        "3".color(Color::Yellow).bold()
    );
    println!("\n  Step 3 (final):");
    println!(
        "              {} + {} + {}",
        "1".color(Color::Magenta).bold(),
    ...
    println!(
        "\n  Pattern: {} + {} + {} + {} + {}",
        "1".color(Color::Magenta),
        "5".color(Color::Blue),
        "seed".color(Color::Yellow),
        "5".color(Color::Blue),
        "1".color(Color::Magenta)
    );
    // Show heat map
    ...
    println!("┌─{}─┐", "─".repeat(58));
    println!(
        "│  {} We just generated your first prime!  │",
        "🎉 Welcome!".color(Color::Yellow).bold()
    );
    println!("│                                                            │");
    println!(
        "│  Try: {} to test all seeds • {} to explore • {} for help  │",
        "G".color(Color::Green).bold(),
        "Tab".color(Color::Cyan).bold(),
    ...
    println!(
        ...
        "No welcome screen".color(Color::Green)
    );
    println!(
        "• {} - Tracks consecutive primes",
        "Streak counter".color(Color::Green)
    );
    println!(
        "• {} - Finds palindromes, lucky 777s",
        "Pattern detection".color(Color::Green)
    );
    println!(
        "• {} - Shows membrane building process",
        "ASCII construction".color(Color::Green)
    );
    println!(
        "• {} - Visual success rate map",
        "Interactive heat map".color(Color::Green)
    );
