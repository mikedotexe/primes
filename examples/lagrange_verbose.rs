...
fn test_lagrange_verbose(prime1: &str, prime2: &str, zero_count: usize) {
    ...
    println!("\n📍 BODY 1: {}", prime1);
    println!("   Status: {}", if is_prime(&p1) { "✅ VERIFIED PRIME" } else { "❌ NOT PRIME" });
    
    println!("\n📍 BODY 2: {}", prime2);  
    println!("   Status: {}", if is_prime(&p2) { "✅ VERIFIED PRIME" } else { "❌ NOT PRIME" });
    ...
    println!("   Primality: {}", if is_prime(&baseline_num) { "✅ PRIME!" } else { "❌ Not prime" });
