...
fn main() {
    ...
    println!("15651 in decimal = {} in base 6", to_base_n(&15651u32.into(), 6));
    
    // And check what 2551 in decimal is in base 6
    println!("2551 in decimal = {} in base 6", to_base_n(&2551u32.into(), 6));
    ...
    for seed in 0..6 {
        ...
        println!("Seed {}: {} (base 6) = {} (decimal) -> {}", 
            seed, 
            base6_str,
            decimal_value,
            if is_prime_result { "PRIME ✓" } else { "composite" }
        );
    }
