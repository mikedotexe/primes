...
fn main() {
    ...
    for x in 1..=9 {
        for y in 1..=9 {
            ...
            if let Ok(num) = BigUint::from_str(&membrane) {
                if is_prime(&num) {
                    println!("✓ {} is PRIME! Structure: {}-00-{}-00-{}", membrane, x, y, x);
                }
            }
        }
    }
    ...
    for x in 1..=3 {
        for y in 1..=9 {
            for z in 1..=9 {
                ...
                if let Ok(num) = BigUint::from_str(&membrane) {
                    if is_prime(&num) {
                        println!("✓ {} is PRIME! Structure: {}{}-0-{}-0-{}{}", 
                            membrane, x, y, z, y, x);
                    }
                }
            }
    ...
    for x in 1..=9 {
        for y in 1..=9 {
            ...
            if let Ok(num) = BigUint::from_str(&membrane) {
                if is_prime(&num) {
                    println!("✓ {} is PRIME! Structure: {}-0-{}-0-{}-0-{}", 
                        membrane, x, y, y, x);
                }
            }
        }
    ...
    for x in 1..=9 {
        for y in 1..=9 {
            ...
            if let Ok(num) = BigUint::from_str(&membrane) {
                if is_prime(&num) {
                    println!("✓ {} is PRIME! Structure: {}-000-{}-000-{}", membrane, x, y, x);
                }
            }
        }
    }
