...
fn main() {
    ...
    println!(
        "Prime 1: {} → {}",
        prime1,
        if is_prime(&prime1.parse::<BigUint>().unwrap()) {
            "✅ PRIME"
        } else {
            "❌ NOT PRIME"
        }
    ...
    println!(
        "Prime 2: {} → {}",
        prime2,
        if is_prime(&prime2.parse::<BigUint>().unwrap()) {
            "✅ PRIME"
        } else {
            "❌ NOT PRIME"
        }
    ...
    println!(
        "Is prime: {}",
        if is_prime(&with_zeros.parse::<BigUint>().unwrap()) {
            "✅ YES"
        } else {
            "❌ NO"
        }
    ...
    println!(
        "Is prime: {}",
        if is_prime(&with_digit.parse::<BigUint>().unwrap()) {
            "✅ YES!"
        } else {
            "❌ NO"
        }
