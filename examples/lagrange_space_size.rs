...
fn test_space_sizes(body1: &str, body2: &str) {
    ...
    println!("Body 1 prime: {}, Body 2 prime: {}", is_prime(&p1), is_prime(&p2));
    
    println!("\n{:<10} {:<15} {:<15} {:<15}", "Space", "L-Points", "Tests", "Success%");
    println!("{}", "-".repeat(60));
    ...
    for space_size in 1..=20 {
        ...
        println!("{:<10} {:<15} {:<15} {:<14.1}", space_size, successes, tests, success_rate);
