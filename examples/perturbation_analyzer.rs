...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "Testing stability of prime at space_size={}, position={}, digit={}",
        space_size, prime_pos, prime_digit
    );
    ...
    println!(
        "Perturbations Survived (remained prime): {}",
    ...
    println!(
        "A higher score indicates the state is robust and exists in a stable 'potential well'."
    );
