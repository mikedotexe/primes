...
#
# This script updates all .agda files to use standard library imports
# instead of the outdated Agda.Builtin.* imports.
...
echo ""
echo "Next steps:"
echo "  1. Test compilation: cd agda-proofs && agda --safe Theorems/Abstract/SymmetryImpliesRepulsion.agda"
echo "  2. If successful, remove backups: find agda-proofs -name '*.agda.bak' -delete"
echo "  3. Commit changes: git add agda-proofs/ && git commit -m 'fix: Update Agda imports for 2.8.0 compatibility'"
