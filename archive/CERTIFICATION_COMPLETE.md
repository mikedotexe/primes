...
>
> This document retains useful historical context about the intended
> certification architecture, but its framing remains too overstated for the
> active public surface. Use `agda-proofs/STATUS.md` for current compilation
> status and treat this file as archival design history.
