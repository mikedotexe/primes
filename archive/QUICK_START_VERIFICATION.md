...
>
> This guide is preserved for research history, but it no longer meets the
> current scrutiny standard. It references multiple example commands that do not
> exist in the current repository and is superseded by
> `README.md` for runnable entrypoints and `agda-proofs/STATUS.md` for current
> Agda ground truth.
