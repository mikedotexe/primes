...
>
> This changelog captures an older release narrative and references artifacts
> that are no longer present in the current repository. It is retained for
> historical context rather than as an audited description of the active codebase.
